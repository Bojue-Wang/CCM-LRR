...
args.data_dir = '../../data'
args.arch = 'resnet_110_spa'
args.lr_type = 'cos'
args.result_dir = 'train_from_raw_resnet_110_cifar_with_ccm_rl_0.01_lambda_0.004_the_best/pruned_result/CCM_finetune_resnet_110_threshold_0.75'
args.batch_size = 256
args.epochs = 600
args.label_smooth = 0
...
args.pretrain_dir = 'train_from_raw_resnet_110_cifar_with_ccm_rl_0.01_lambda_0.004_the_best/checkpoint.pth.tar'
args.ci_dir = 'train_from_raw_resnet_110_cifar_with_ccm_rl_0.01_lambda_0.004_the_best/CI_resnet_110'
args.gpu = '0'
args.threshold = 0.75
...
def main():
    ...
    # calculate sparsity
    channel_reserved_by_CI, sparsity = prepare_prune(args.ci_dir, 109, args.threshold)
    ...
    origin_model = resnet_110_spa(sparsity=[0.] * 100, sparsity_type='original').cuda()
    # calculate model size
    input_image_size = 32
    input_image = torch.randn(1, 3, input_image_size, input_image_size).cuda()
