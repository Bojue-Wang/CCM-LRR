...
args.data_dir = '../../data'
args.arch = 'resnet_56_spa'
args.lr_type = 'cos'
args.result_dir = 'train_from_raw_resnet_56_cifar_with_ccm_test2_rl_0.01_lambda_0.01_the_best/pruned_result/CCM_finetune_resnet_56_threshold_0.65_test'
args.batch_size = 256
args.epochs = 600
args.label_smooth = 0
...
args.ci_dir = 'train_from_raw_resnet_56_cifar_with_ccm_test2_rl_0.01_lambda_0.01_the_best/CI_resnet_56'
args.gpu = '0'
args.threshold = 0.65
...
def main():
    ...
    # calculate sparsity
    channel_reserved_by_CI, sparsity = prepare_prune(args.ci_dir, 55, args.threshold)
    ...
    origin_model = resnet_56_spa(sparsity=[0.] * 100, sparsity_type='original').cuda()
    # calculate model size
    input_image_size = 32
    input_image = torch.randn(1, 3, input_image_size, input_image_size).cuda()
