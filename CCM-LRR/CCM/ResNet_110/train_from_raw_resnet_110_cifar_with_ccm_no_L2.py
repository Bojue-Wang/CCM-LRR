...
parser = argparse.ArgumentParser("CIFAR-10 training resnet_110")
...
args.lr_type = 'cos'
args.result_dir = './result/train_from_raw_resnet_110_cifar_with_ccm_no_L2'
args.batch_size = 256
args.epochs = 400
args.label_smooth = 0
...
if args.visdom:
    ...
    vis = Visdom(env='train_from_raw_resnet_110_with_ccm_no_L2')
