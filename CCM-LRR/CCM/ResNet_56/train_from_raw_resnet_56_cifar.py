...
parser = argparse.ArgumentParser("CIFAR-10 training resnet_56")
...
args.arch = 'resnet_56'
args.lr_type = 'cos'
args.result_dir = './result/train_from_raw_resnet_56_cifar'
args.batch_size = 256
args.epochs = 400
args.label_smooth = 0
...
if args.visdom:
    ...
    vis = Visdom(env='train_from_raw_resnet_56')
...
def main():
    ...
    while epoch < args.epochs:
        if args.label_smooth > 0:
            train_obj, train_top1_acc, train_top5_acc, train_CCM_loss = train(epoch, train_loader, model,
                                                                             criterion_smooth,
                                                                             optimizer)
        else:
