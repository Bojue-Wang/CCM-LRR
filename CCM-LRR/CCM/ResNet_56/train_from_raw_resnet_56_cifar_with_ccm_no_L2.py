...
args.arch = 'resnet_56'
args.lr_type = 'cos'
args.result_dir = './result/train_from_raw_resnet_56_cifar_with_ccm_no_L2'
args.batch_size = 256
args.epochs = 400
args.label_smooth = 0
...
if args.visdom:
    ...
    vis = Visdom(env='train_from_raw_resnet_56_with_ccm_no_L2')
...
def train(epoch, train_loader, model, criterion, optimizer, scheduler=None):
    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        loss = data_loss - CCM_loss * 0.0499
